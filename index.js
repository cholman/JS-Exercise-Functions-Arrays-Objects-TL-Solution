...
console.log(temperatureInF(100, 'F'));
...
console.log(makePersonObject(1, "Cody", "holman.cody@gmail.com"));
...
let Cody = {
  id: 1,
  name: "Cody",
  email: "holman.cody@gmail.com"
}
function getName(person) {
  return (person.name);
}

console.log(getName(Cody))/**
...
let newFruit = [ 'orange', 'apple', 'banana', 'apples', 'apple', 'mango' ]
console.log(isItAnApple(newFruit));
